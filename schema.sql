-- =====================================================
-- COACH NUTRITIONNEL IA - SCHEMA POSTGRESQL COMPLET
-- =====================================================
-- Version: 1.0
-- Date: 2025-06-23
-- Description: Architecture complète pour coach nutritionnel anti-inflammatoire
-- Cible: Utilisateurs français uniquement, abonnement 5.99€/mois
...
GROUP BY r.id, r.name, r.anti_inflammatory_score, r.difficulty_level, r.total_time_minutes;
