-- =====================================================
-- COACH NUTRITIONNEL IA - BASE DE DONNÉES ALIMENTAIRE (CORRIGÉE)
-- =====================================================
-- Version: 1.0
-- Date: 2025-06-23
...
CREATE TABLE foods (
  ...
  image_url text,
  source_refs text[], -- CORRIGÉ: changé de "source_references" à "source_refs"
...
CREATE TABLE food_combinations (
  ...
  scientific_refs text[], -- CORRIGÉ: changé de "references" à "scientific_refs"
